                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-materialdesign" class="nav-link"><span>@lang('translation.material-design')</span>
                            ...
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><span>@lang('translation.feather')</span>
